...
colnames(tabela_completa) = c("Simples (Não)", "Simples (Sim)", "Relativa (Não)", "Relativa (Sim)")
...
colnames(complete_table) = c("Simples (TV? Não)", "Simples (TV? Sim)", "Relativa (TV? Não)", "Relativa (TV? Sim)")
...
colnames(Полная_таблица) = c("Simples (Espanhol)", "Simples (Inglês)", "Relativa (Espanhol)", "Relativa (Inglês)")
